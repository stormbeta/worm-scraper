...
function getBodyXML(chapter, contentEl) {
  // Fix for some chapters in The Wandering Inn having weird inner div
  if(contentEl.querySelector("div#paste-embed-wrapper") != null) {
    contentEl = contentEl.querySelector("div#paste-embed-wrapper")
  }

  // Remove initial Next Chapter and Previous Chapter <p>
  if(contentEl.firstElementChild.querySelector("a") != (null) && contentEl.firstElementChild.querySelector("a").text.match('Chapter') != null) {
