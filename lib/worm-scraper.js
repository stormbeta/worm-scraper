...
const argv = yargs
  ...
  .command("download", "download all chapters by crawling twigserial.wordpress.com")
  ...
  .option("s", {
    alias: "start-url",
    default: "https://practicalguidetoevil.wordpress.com/2015/03/25/prologue/",
  ...
  .option("o", {
    alias: "out",
    default: "A Practical Guide to Evil.epub",
